#ifndef ACTORIDLISTENER_H
#define ACTORIDLISTENER_H
...
class ActorIDListener : public b2ContactListener
{
	public:
		///Default constructor.
        /// \param context Current context of the application.
		ActorIDListener(State::Context context);
