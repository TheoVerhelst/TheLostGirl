...
Interpreter::Interpreter():
	m_precedence{{"or", 1},
				...
				{"!", 1},
				{"=", 0}},
	m_functions{{"print", {-1, ScriptFunctions::print}},
				{"<", {2, ScriptFunctions::lowerThanOp}},
				{">", {2, ScriptFunctions::greaterThanOp}},
				{"<=", {2, ScriptFunctions::lowerEqualOp}},
				{">=", {2, ScriptFunctions::greaterEqualOp}},
				{"==", {2, ScriptFunctions::equalOp}},
				{"is", {2, ScriptFunctions::equalOp}},
				{"!=", {2, ScriptFunctions::notEqualOp}},
				{"and", {2, ScriptFunctions::andOp}},
				{"or", {2, ScriptFunctions::orOp}},
				{"+", {2, ScriptFunctions::addOp}},
				{"-", {2, ScriptFunctions::substractOp}},
				{"*", {2, ScriptFunctions::multiplyOp}},
				{"/", {2, ScriptFunctions::divideOp}},
				{"%", {2, ScriptFunctions::moduloOp}},
				{"!", {1, ScriptFunctions::notOp}},
				{"=", {2, nullptr}},
				{"nearest foe", {1, ScriptFunctions::nearestFoe}},
				{"distance from", {2, ScriptFunctions::distanceFrom}},
				{"direction to", {2, ScriptFunctions::directionTo}},
				{"direction of", {1, ScriptFunctions::directionOf}},
				{"attack", {1, ScriptFunctions::attack}},
				{"can move", {1, ScriptFunctions::canMove}},
				{"move", {2, ScriptFunctions::move}},
				{"stop", {1, ScriptFunctions::stop}},
				{"can jump", {1, ScriptFunctions::canJump}},
				{"jump", {1, ScriptFunctions::jump}},
				{"isValid", {1, ScriptFunctions::isValid}}},
	m_initialVars{{"left", Direction::Left},
